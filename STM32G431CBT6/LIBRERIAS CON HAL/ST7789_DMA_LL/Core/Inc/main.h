...
/* Private defines -----------------------------------------------------------*/
#define SW3_Pin LL_GPIO_PIN_1
#define SW3_GPIO_Port GPIOA
#define IN_TS3A5018_Pin LL_GPIO_PIN_3
...
#define LCD_RES_Pin LL_GPIO_PIN_1
#define LCD_RES_GPIO_Port GPIOB
#define LCD_CS_Pin LL_GPIO_PIN_2
#define LCD_CS_GPIO_Port GPIOB
#define ALERT_INA_Pin LL_GPIO_PIN_10
#define ALERT_INA_GPIO_Port GPIOB
#define LINK_Pin LL_GPIO_PIN_11
#define LINK_GPIO_Port GPIOB
#define CS_SD_Pin LL_GPIO_PIN_12
#define CS_SD_GPIO_Port GPIOB
#define IN_CHARGER_Pin LL_GPIO_PIN_8
#define IN_CHARGER_GPIO_Port GPIOA
#define STDBY_Pin LL_GPIO_PIN_11
#define STDBY_GPIO_Port GPIOA
#define CHRGB_Pin LL_GPIO_PIN_12
#define CHRGB_GPIO_Port GPIOA
#define IN_DRAIN_LATCH_Pin LL_GPIO_PIN_6
#define IN_DRAIN_LATCH_GPIO_Port GPIOB
#define ON_OFF_3V7_Pin LL_GPIO_PIN_7
