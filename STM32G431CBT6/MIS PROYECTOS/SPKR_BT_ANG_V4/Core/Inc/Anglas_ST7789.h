...
void ST7789_WriteChar2(uint16_t x, uint16_t y, char ch, FontDef font, uint16_t color, uint16_t bgcolor, uint8_t multiplier);
void ST7789_WriteString(uint16_t x, uint16_t y, const char* str, FontDef font, uint16_t color, uint16_t bgcolor, uint8_t multiplier);
void ST7789_Print(uint16_t x, uint16_t y, uint16_t color, uint16_t bgcolor, FontDef font, const char *str);
void ST7789_Print2(uint16_t y, uint16_t x, uint16_t color, uint16_t bgcolor, FontDef font, const char *str, uint8_t multiplier);
...
void Measure_FPS_FillScreenColor(void);
void Measure_FPS_ImageBMP(void);
