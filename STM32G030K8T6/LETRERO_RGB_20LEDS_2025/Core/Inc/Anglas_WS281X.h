...
// Definiciones de los colores 100%
...
// Definiciones de los colores 50%
#define AMARILLO_50_1 BRILLO_MAX, BRILLO_MID, BRILLO_OFF
#define AMARILLO_50_2 BRILLO_MID, BRILLO_MAX, BRILLO_OFF
#define CIAN_50_1     BRILLO_OFF, BRILLO_MAX, BRILLO_MID
#define CIAN_50_2     BRILLO_OFF, BRILLO_MID, BRILLO_MAX
#define MAGENTA_50_1  BRILLO_MAX, BRILLO_OFF, BRILLO_MID
#define MAGENTA_50_2  BRILLO_MID, BRILLO_OFF, BRILLO_MAX

#define BLANCO_50_1   BRILLO_MID, BRILLO_MID, BRILLO_MAX
#define BLANCO_50_2   BRILLO_MAX, BRILLO_MID, BRILLO_MID
#define BLANCO_50_3   BRILLO_MID, BRILLO_MAX, BRILLO_MID
// Direccioes
#define IZQ      1
#define DER_IZQ -1
/* Exported macros -----------------------------------------------------------*/
...
void Respirar(uint8_t veces, uint8_t tiempo, uint8_t r, uint8_t g, uint8_t b);//OK
