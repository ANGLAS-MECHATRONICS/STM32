...
int16_t val_Min_Encoder = 211;//30.0V
int16_t val_Max_Encoder = 3878;//0.1V
int16_t valor_Encoder   = 0;//valor inicial del encoder
int16_t paso_Encoder    = 12; //con 12 sube aprox +-0.1V
uint8_t flagAnt = 0, flagHor = 0;
/* Private functions ---------------------------------------------------------*/

/* Exported functions --------------------------------------------------------*/
uint16_t Encoder_Run(void){
