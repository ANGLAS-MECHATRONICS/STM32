...
const uint16_t image_data_avatar[1600] = { //texture of my avatar
...
const uint16_t image_data_volume[1024] = { //volume icon texture with alpha channel
...
const uint16_t image_data_x[1024] = { //X icon texture with alpha channel
0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
