...
//hardware and software init
  ...
  //CAMERA_IO_Write(0x60, 0xFF, 0x00);//Selecciona el banco de registros DSP del OV2640
  //CAMERA_IO_Write(0x60, 0xDA, 0x08);//Fuerza la salida del sensor a RGB565
  //CAMERA_IO_Write(0x60, 0xD7, 0x03);//Ajusta el orden y empaquetado de bytes RGB
}
